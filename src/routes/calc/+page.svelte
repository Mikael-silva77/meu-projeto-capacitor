...
<input class="form-control" readonly bind:value=
{display} style="font-weight:600;" />
<table class="table table-sm table-borderless">
    <tbody>
            <tr>
                <td><button  class="btn  btn-warning w-100" onclick={()=>clear()}>c</button></td>
                <td><button  class="btn btn-success w-100" onclick={()=>press('(')}>&lpar;</button></td>
                <td><button  class="btn btn-success w-100" onclick={()=>press(')')}>&rpar;</button></td>
            ...
            <tr>
                ...
                <td rowspan="2" style="height: 0;"><button  class="btn btn-primary w-100" onclick={()=>press('+')}>+</button></td>
            </tr>
            <tr>
